...
public class KafkaLogAspect {
    ...
    AtomicLong atomicInteger = new AtomicLong(1000);
...
//        ProducerRecord<String, KafkaLogModel> record = new ProducerRecord<>(logTopics, String.valueOf(kafkaLogModel.getLogId()), kafkaLogModel);
...
//    }
    ...
    private Object buildMsgModel(ProceedingJoinPoint proceedingJoinPoint, KafkaLogModel kafkaLogModel, String service) throws Throwable {
        ...
        kafkaLogModel.setLogId(atomicInteger.getAndIncrement());
